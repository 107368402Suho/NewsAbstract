...
def get_stops_words():
    with open("./stopwords.txt", "r", encoding='utf-8') as fo:
...
def is_there_speak(Verb_and_Subject_result_of_ltp_process):
    ...
    manl_add_speak = ['讨论', '交流', '讲话', '说话', '吵架', '争吵', '勉励', '告诫', '戏言', '嗫嚅', '沟通', '切磋', '争论', '研究', '辩解', '坦言',
                      ...
                      '傻话', '胡话', '俗话', '废话', '发言', '婉言', '危言', '谎言', '直言', '预言', '诺言', '诤言', '表示', '交谈', '提到', '说到', '强调'
                      '表明', '认为', '决定', '报道']
    # 1.2 迭代10次加入的这些
...
if __name__ == "__main__":
    ...
    #paragraph  = '康威说：“我认为总统已经说得很清楚了，他对中国不高兴——他们向我国和全世界释放了‘中国病毒’，而且没有什么透明度和诚实度，能得到的资讯非常少”。'
    print(main(paragraph))
