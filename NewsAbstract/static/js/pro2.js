    ...
    $(".nav-stacked > li").eq(0).click(function () {
        ...
        if (cur != "信息提取") {
            ...
            if (result['summarization'] != undefined) {
                var temp = "";
                temp = "<span style=\"font-size:24px;\">信息提取</span><hr style=\"border-top:\
                ...
                var s = result['summarization']
                for (var dict in s){
                    console.log(dict)
                    var item = s[dict]
                    temp += "<tr><td>" + item[0] + "</td><td>" + item[2] + "</td></tr>";
                }
                temp+= "</table>"
//                temp = "<ul style=\" width: 500px; margin:0 auto:list-style:none;\">"
//                var s = result['summarization']
//                for (var dict in s){
//                    console.log(dict)
//                    var item = s[dict]
//                    temp += "<li style =\" width:250px; float:left;\">" + item[0] + "</li> <li style =\"width:250px;float:left;\">" + item[2] + "</li>";
//
//                }
//                temp+= "</ul>"
                $(".showpalce").html(temp);
